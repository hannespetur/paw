...
TEST_CASE("Split an empty vector")
{
  ...
  auto find_non_zero_lambda = [](std::shared_ptr<std::vector<double> > dd){
                                return dd->size() != 0;
                              };

  SECTION("One part")
  {
    auto split_doubles = paw::split(doubles, 1 /*PARTS*/);
    REQUIRE(split_doubles.size() == 1);
    REQUIRE(split_doubles[0]->size() == 0);

    // Split by iterators results in the same vector
    auto split_doubles_by_it = paw::split(doubles.begin(), doubles.end(), 1 /*PARTS*/);
  ...
  SECTION("Two parts")
  {
    auto split_doubles = paw::split(doubles, 2 /*PARTS*/);
    ...
    // Split by iterators results in the same vector
    auto split_doubles_by_it = paw::split(doubles.begin(), doubles.end(), 2 /*PARTS*/);
    REQUIRE(split_doubles_by_it.size() == 2);
    find_it = std::find_if(split_doubles_by_it.begin(),
                           split_doubles_by_it.end(), find_non_zero_lambda);
    REQUIRE(find_it == split_doubles_by_it.end());
  }

  SECTION("322 parts")
  {
    auto split_doubles = paw::split(doubles, 322 /*PARTS*/);
    REQUIRE(split_doubles.size() == 322);
    auto find_it = std::find_if(split_doubles.begin(), split_doubles.end(), find_non_zero_lambda);
    REQUIRE(find_it == split_doubles.end());

    // Split by iterators results in the same vector
    auto split_doubles_by_it = paw::split(doubles.begin(), doubles.end(), 322 /*PARTS*/);
...
TEST_CASE("Split some vector")
{
  ...
  SECTION("One part")
  {
    auto split_ints = paw::split(ints, 1 /*PARTS*/);
  ...
  SECTION("Two parts")
  {
    auto split_ints = paw::split(ints, 2 /*PARTS*/);
  ...
  SECTION("Three parts")
  {
    auto split_ints = paw::split(ints, 3 /*PARTS*/);
    ...
    auto split_ints_by_it = paw::split(ints.begin(), ints.end(), 3 /*PARTS*/);
  ...
  SECTION("Ten parts")
  {
    auto split_ints = paw::split(ints, 10 /*PARTS*/);
...
TEST_CASE("Split a list")
{
  ...
  SECTION("Two parts")
  {
    auto split_floats = paw::split(floats, 2 /*PARTS*/);
...
TEST_CASE("Split a deque")
{
  ...
  SECTION("Three parts")
  {
    auto split_unsigneds = paw::split(unsigneds, 3 /*PARTS*/);
